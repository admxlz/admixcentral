...
class InstallCommand extends Command
{
    ...
    {
        $this->info('  ___      _           _        _____           _             _ ');
        $this->info(' / _ \    | |         (_)      /  __ \         | |           | |');
        $this->info('/ /_\ \ __| |_ __ ___  ___  __ | /  \/ ___ _ __| |_ _ __ __ _| |');
        $this->info('|  _  |/ _` | \'_ ` _ \| \ \/ / | |    / _ \ \'__| __| \'__/ _` | |');
        $this->info('| | | | (_| | | | | | | |>  <  | \__/\  __/ |  | |_| | | (_| | |');
        $this->info('\_| |_/\__,_|_| |_| |_|_/_/\_\  \____/\___|_|   \__|_|  \__,_|_|');
        $this->info('');
