        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('users.update', $user) }}" method="POST" x-data="{
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}"
                                    required x-model="email" @blur="checkEmail()"
                                    class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500"
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button
                                x-bind:disabled="emailError || role === '' || companyId === '' || isCheckingEmail || (password.length > 0 && passwordScore < 3) || (password.length > 0 && password !== passwordConfirm)"
