            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('users.update', $user) }}" method="POST"
                          x-data="{
                              companyId: '{{ old('company_id', $user->company_id ?? 'global') }}',
                        ...
                        <div class="mb-4">
                            <label for="password"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Password (Leave blank
                        ...
                        <div class="flex items-center gap-4">
                            <button type="submit"
                                :disabled="emailError || role === '' || companyId === '' || isCheckingEmail || (password.length > 0 && passwordScore < 3) || (password.length > 0 && password !== passwordConfirm)"
                                :class="{'opacity-50 cursor-not-allowed': emailError || role === '' || companyId === '' || isCheckingEmail || (password.length > 0 && passwordScore < 3) || (password.length > 0 && password !== passwordConfirm)}"
